...
for (.i in 1:nrow(catalogue)) {
  ...
  if (.a_text_id_last == "welcome") {
    ...
    .gid = .a_text_id[[1]][2]
    #lsSetGroupProperties(groupID = .gid, properties = list(group_name = .target_text))
    # TODO
...
## Groups and answer options workaround: manipulating the LSS file with PHP
...
write.csv(answer_options, file = paste0(.baseFileName, ".", lang, ".csv"))
```
